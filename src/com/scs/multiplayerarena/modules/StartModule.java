...
public class StartModule implements IModule, ActionListener, RawInputListener {
	...
	public StartModule(MultiplayerArenaMain _game, GameMode _gameMode) {
		super();
	...
	public void init() {
		...
		newCam.resize(MultiplayerArenaMain.settings.getWidth(), MultiplayerArenaMain.settings.getHeight(), true);
		...
		BitmapText screenText = new BitmapText(MultiplayerArenaMain.guiFont_small, false);
		...
		BitmapText gameModeSpecificText = new BitmapText(MultiplayerArenaMain.guiFont_small, false);
		...
		BitmapText numPlayerText = new BitmapText(MultiplayerArenaMain.guiFont_small, false);
	...
	public void onAction(String name, boolean value, float tpf) {
		...
		if (name.equals(START)) {
			...
			MultiplayerArenaMain.properties.saveProperties();
			game.stop();
		}
	}

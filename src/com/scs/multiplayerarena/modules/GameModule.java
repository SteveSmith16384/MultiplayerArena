...
import com.scs.multiplayerarena.entities.Collectable;
import com.scs.multiplayerarena.entities.CubeExplosionShard;
import com.scs.multiplayerarena.entities.DodgeballBall;
import com.scs.multiplayerarena.entities.PhysicalEntity;
import com.scs.multiplayerarena.entities.PlayersAvatar;
import com.scs.multiplayerarena.entities.RoamingAI;
import com.scs.multiplayerarena.hud.HUD;
import com.scs.multiplayerarena.input.IInputDevice;
import com.scs.multiplayerarena.input.JoystickCamera2;
import com.scs.multiplayerarena.input.MouseAndKeyboardCamera;
import com.scs.multiplayerarena.map.FlatWorld;
import com.scs.multiplayerarena.map.IPertinentMapData;
...
public class GameModule implements IModule, PhysicsCollisionListener, ActionListener {//, PhysicsTickListener {
	...
	public GameModule(MultiplayerArenaMain _game) {
		super();
	...
	public void createDodgeballBall() {
		...
		MultiplayerArenaMain.instance.getRootNode().attachChild(c.getMainNode());

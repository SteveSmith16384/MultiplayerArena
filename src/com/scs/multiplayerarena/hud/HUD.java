...
import com.scs.multiplayerarena.gui.TextArea;
...
public class HUD extends Node implements IEntity, IProcessable {
	...
	public HUD(MultiplayerArenaMain _game, GameModule _module, float xBL, float yBL, float w, float h, BitmapFont font_small, int id, Camera _cam) {
		super("HUD");

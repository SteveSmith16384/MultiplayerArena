...
import com.scs.multiplayerarena.entities.Fence;
import com.scs.multiplayerarena.entities.PhysicalEntity;
import com.scs.multiplayerarena.entities.SimplePillar;
import com.scs.multiplayerarena.modules.GameModule;
import com.scs.multiplayerarena.shapes.CreateShapes;
...
public class SimpleMapLoader implements IMapLoader {
	...
	public SimpleMapLoader(MultiplayerArenaMain _game, GameModule _module, ISimpleMapData _data) {
		game = _game;
		module = _module;
		this.map = _data;

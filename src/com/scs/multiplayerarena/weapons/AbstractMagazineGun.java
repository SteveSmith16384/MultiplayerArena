...
public abstract class AbstractMagazineGun implements IAbility {
	...
	public AbstractMagazineGun(MultiplayerArenaMain _game, GameModule _module, String _name, ICanShoot _shooter, float shotInt, float reloadInt, int magSize) {
		super();
	...
	public abstract void launchBullet(MultiplayerArenaMain _game, GameModule _module, ICanShoot _shooter);

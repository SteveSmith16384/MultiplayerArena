...
import com.scs.multiplayerarena.MyBetterCharacterControl;
...
import com.scs.multiplayerarena.abilities.Invisibility;
import com.scs.multiplayerarena.abilities.JetPac;
import com.scs.multiplayerarena.abilities.RunFast;
import com.scs.multiplayerarena.abilities.Spellbook;
...
import com.scs.multiplayerarena.components.IDamagable;
...
import com.scs.multiplayerarena.components.ITargetByAI;
import com.scs.multiplayerarena.hud.AbstractHUDImage;
import com.scs.multiplayerarena.hud.HUD;
import com.scs.multiplayerarena.input.IInputDevice;
import com.scs.multiplayerarena.map.SimpleCity;
import com.scs.multiplayerarena.models.RobotModel;
import com.scs.multiplayerarena.modules.GameModule;
import com.scs.multiplayerarena.weapons.DodgeballGun;
import com.scs.multiplayerarena.weapons.LaserRifle;
...
public class PlayersAvatar extends PhysicalEntity implements IProcessable, ICollideable, ICanShoot, IShowOnHUD, ITargetByAI, IAffectedByPhysics, IDamagable {
	...
	public PlayersAvatar(MultiplayerArenaMain _game, GameModule _module, int _playerID, Camera _cam, IInputDevice _input, HUD _hud) {
	...
	public static Spatial getPlayersModel(MultiplayerArenaMain game, int pid) {
	...
	public void moveToStartPostion(boolean invuln) {
		...
		if (invuln) {
			invulnerableTime = MultiplayerArenaMain.properties.GetInvulnerableTimeSecs();
		}
	}
	...
	private void died(String reason) {
		...
		this.restartTime = MultiplayerArenaMain.properties.GetRestartTimeSecs();
	...
	public void collidedWith(ICollideable other) {
		if (other instanceof IBullet) {
			...
			incScore(MultiplayerArenaMain.BASE_SCORE_INC, " on base ");
		}
	}

...
public class RotatingTurret extends PhysicalEntity implements ICollideable {

	public RotatingTurret(MultiplayerArenaMain _game, GameModule _module, float x, float y, float z, float rotDegrees) {
		super(_game, _module, "RotatingTurret");

		float w = .3f;
		float h = .5f;		
		
		Box box1 = new Box(w/2, h/2, w/2);
